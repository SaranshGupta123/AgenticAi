...
export const ChatInterface = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      streamAnswer(data.answer ?? data.final_answer ?? "No answer.");
    } catch {
      ...
      <div className="border-t border-slate-200 p-4 bg-slate-50">
        <div className="relative w-full">
          ...
          <button
            ...
            title="Send query"
            className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-full bg-blue-600 hover:bg-blue-700 text-white disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors duration-150 shadow-sm"
          >
